            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav nav-links-container mx-auto">
                <li className="nav-item">
                  <Link to="/bottle" className="nav-link">Bottles</Link>
                </li>
                <li className="nav-item">
                  <Link to="/pitchers" className="nav-link">Pitchers</Link>
                </li>
                <li className="nav-item">
                  <Link to="/bottles" className="nav-link">Shop All</Link>
                </li>
                ...
                <li className="nav-item">
                  <Link to="/water" className="nav-link">Water Quality</Link>
                </li>
              </ul>
